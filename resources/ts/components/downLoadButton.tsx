		...
		<>
			...
			<dialog id={DownLoadButtonProps.dialog} className='w-75'>
				...
				<div className="mr-auto d-flex justify-content-end">
					<button type="button" className='btn btn-primary' onClick={() => handleClickOk(`https://klgsmhsnitool.gulk.co.jp/dlc/${DownLoadButtonProps.fileName}.${DownLoadButtonProps.fileNameType}`, `${DownLoadButtonProps.fileName}.${DownLoadButtonProps.fileNameType}`)}>Ok</button>
