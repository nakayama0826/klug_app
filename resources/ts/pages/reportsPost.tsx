...
const ReportsPost = () => {
	...
	const [formData, setFormData] = useState({
		...
		work_style1: data?.reportsPost?.work_style1 || data?.lastReports?.work_style1 || '',
		...
		work_style2: data?.reportsPost?.work_style2 || data?.lastReports?.work_style2 || '',
		...
		work_style3: data?.reportsPost?.work_style3 || data?.lastReports?.work_style3 || '',
		...
		work_style4: data?.reportsPost?.work_style4 || data?.lastReports?.work_style4 || '',
		...
		work_style5: data?.reportsPost?.work_style5 || data?.lastReports?.work_style5 || '',
		...
		work_style6: data?.reportsPost?.work_style6 || data?.lastReports?.work_style6 || '',
		...
		work_style7: data?.reportsPost?.work_style7 || data?.lastReports?.work_style7 || '',
	});
				...
				<div className="post_container pt-1 px-0">
					...
					<form onSubmit={(e) => handleSubmit(e)}>
						...
						<div className="row pb-2">
							...
							<div className="col-1">
								<input id="work_style1" type="checkbox" name="work_style1" checked={formData.work_style1} onChange={(e) => change(e)} />
							</div>
						</div>
						<div className="row pb-2">
							<div className="col-5">
							...
							<div className="col-1">
								<input id="work_style2" type="checkbox" name="work_style2" checked={formData.work_style2} onChange={(e) => change(e)} />
							</div>
						</div>
						<div className="row pb-2">
							<div className="col-5">
							...
							<div className="col-1">
								<input id="work_style3" type="checkbox" name="work_style3" checked={formData.work_style3} onChange={(e) => change(e)} />
							</div>
						</div>
						<div className="row pb-2">
							<div className="col-5">
							...
							<div className="col-1">
								<input id="work_style4" type="checkbox" name="work_style4" checked={formData.work_style4} onChange={(e) => change(e)} />
							</div>
						</div>
						<div className="row pb-2">
							<div className="col-5">
							...
							<div className="col-1">
								<input id="work_style5" type="checkbox" name="work_style5" checked={formData.work_style5} onChange={(e) => change(e)} />
							</div>
						</div>
						<div className="row pb-2">
							<div className="col-5">
							...
							<div className="col-1">
								<input id="work_style6" type="checkbox" name="work_style6" checked={formData.work_style6} onChange={(e) => change(e)} />
							</div>
						</div>
						<div className="row pb-2">
							<div className="col-5">
							...
							<div className="col-1">
								<input id="work_style7" type="checkbox" name="work_style7" checked={formData.work_style7} onChange={(e) => change(e)} />
							</div>
						</div>
						<div>
